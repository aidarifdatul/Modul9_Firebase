...
import { deleteNote } from "../../../actions/AuthAction"; // Menambahkan Authentication untuk delete Note
...
const ListNote = ({ judul, isi, tanggal, status, category, noteId }) => {
  ...
  const handleDeleteClick = () => {
    deleteNote(noteId); // Menambahkan kodingan disamping untuk mengabil id-note
